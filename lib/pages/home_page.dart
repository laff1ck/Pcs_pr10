...
import 'package:pr_10/models/api_service.dart';
import 'package:pr_10/components/item.dart';
import 'package:pr_10/components/note_card.dart';
import 'package:pr_10/models/note.dart';
import 'package:pr_10/models/cart.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: const BoxDecoration(
        color:  Color.fromARGB(211, 181, 169, 165),
      ),
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          onTap: _onItemTapped,
          selectedItemColor: const Color.fromARGB(211, 193, 193, 115),
